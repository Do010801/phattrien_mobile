      ...
      return (
        <Card {...panResponder.panHandlers}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
            <Icon raised reverse type="font-awesome" color="#f50" name={this.props.favorite ? "heart" : "heart-o"}
              onPress={() =>
                this.props.favorite
            ...
            />
            <Icon raised reverse type="font-awesome" name="pencil" color="#33CC99"
  ...
  renderCommentItem(item, index) {
    return (
      <View key={index} style={{ margin: 15 }}>
        ...
        <Rating startingValue={item.rating} imageSize={16} readonly style={{ flexDirection: 'row', marginTop: 5 }} />
        <Text style={{ fontSize: 12, marginTop: 5, marginBottom: 20 }}> {"-- " + item.author + ", " + item.date} </Text>
        <Card.Divider />
      </View>
    );
  }
  ...
  render() {
    ...
    return (
      <View style={{ justifyContent: 'center', margin: 20 }}>
        <Rating startingValue={this.state.rating} showRating={true} fractions="{1}"
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
          <Button title='SUBMIT' color='#33CC99'
            onPress={() => this.handleSubmit()} />
          <View style={{ width: 30 }} />
          <Button title='CANCEL' color='#f50'
